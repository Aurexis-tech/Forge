// Per-tool test — compute.text_transform seed tool.
...
describe('compute.text_transform — slug', () => {
...
describe('compute.text_transform — kebab + snake + title', () => {
...
describe('compute.text_transform — truncate', () => {
...
describe('compute.text_transform — normalize_whitespace', () => {
...
describe('compute.text_transform — edge cases', () => {
...
describe('compute.text_transform — determinism', () => {
...
describe('compute.text_transform — examples parse against schemas', () => {
