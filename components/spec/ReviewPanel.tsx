      ...
      <div className="flex flex-col gap-6">
        <div className="flex flex-wrap items-center justify-between gap-3">
          ...
          <p className="font-mono text-[10px] uppercase tracking-[0.3em] text-forge-dim">
            building is blocked until this spec is confirmed
          </p>
        </div>
        ...
        <div className="flex flex-wrap items-center justify-end gap-3 border-t border-white/5 pt-5">
          ...
          >
            {confirming ? 'Locking…' : 'Confirm spec'}
          </button>
        </div>
        ...
        {showRefine ? (
          ...
          >
            ...
            <textarea
              ...
              rows={3}
              disabled={refining}
              placeholder="e.g. 'this should run on Mondays only, not every day' or 'add a constraint: never email more than once per day'"
